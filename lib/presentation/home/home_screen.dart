...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _handleDateTap(int day) {
    setState(() {
      _selectedDate = DateTime(2024, 12, day);
    });
    _openCalendar();
  }
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: Text(
                  'Today, ${selectedDate.day} ${monthNames[selectedDate.month - 1]} ${selectedDate.year}',
          ...
          _DatePager(selectedDay: selectedDate.day, onDateTap: onDateTap),
...
class _DatePager extends StatelessWidget {
  const _DatePager({required this.selectedDay, required this.onDateTap});
  ...
  static const List<_DateItem> items = [
    ...
    _DateItem(label: 'TU', day: '22', hasIndicator: true),
...
class _DatePill extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final Color circleColor = isSelected ? AppColors.background : AppColors.surface;
    final Color borderColor = isSelected ? AppColors.primary : Colors.transparent;
    final Color textColor = isSelected ? AppColors.textPrimary : AppColors.textSecondary;

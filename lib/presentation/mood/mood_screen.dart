...
class _MoodScreenState extends State<MoodScreen> {
  late final List<_MoodOption> _moods = const [
    _MoodOption(label: 'Euphoric', color: Color(0xFFFF9F7B), emoji: '🤩'),
    _MoodOption(label: 'Joyful', color: Color(0xFFFFC27C), emoji: '😄'),
    _MoodOption(label: 'Calm', color: Color(0xFF7ADFCF), emoji: '😌'),
    _MoodOption(label: 'Focused', color: Color(0xFF5EC7DF), emoji: '🧠'),
    _MoodOption(label: 'Inspired', color: Color(0xFF9A8BFF), emoji: '✨'),
    _MoodOption(label: 'Grateful', color: Color(0xFFF884C9), emoji: '🙏'),
  ];
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Mood', style: textTheme.headlineSmall?.copyWith(fontSize: 32)),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 12),
                  Text(
                    'Drag the selector to log your mood',
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                ...
                child: _MoodFace(selectedMood: widget.moods[_selectedIndex]),
              ),
            ),
            Positioned(
...
class _MoodFace extends StatelessWidget {
  const _MoodFace({required this.selectedMood});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            selectedMood.emoji,
            style: const TextStyle(fontSize: 48, color: Color(0xFF3F2E3E)),
          ),
          const SizedBox(height: 4),
          Text(
            selectedMood.label,
